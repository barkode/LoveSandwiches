...
def get_sales_data():
    ...
    '''
    while True:
        print("Please enter sales data from the last merket.")
...
def get_last_5_entries_sales():
    '''
    Cpllect collumns of data from sales worksheet, collecting
    the kast 5 entries for eaach sandwich and returns the data
    as a list of lists.
    '''
